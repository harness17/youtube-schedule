...
| channel | テストファイル | 状態 |
|---|---|---|
| `auth:check` | `tests/main/ipc/authHandlers.test.js` | 未 |
| `auth:login` | 同上 | 未 |
| `auth:logout` | 同上 | 未 |
| `auth:importCredentials` | 同上 | 未 |
| `schedule:get` | `tests/main/ipc/videoHandlers.test.js` | 未 |
| `schedule:feed` | 同上 | 未 |
| `schedule:refresh` | 同上 | 未 |
| `schedule:resetDatabase` | `tests/main/ipc/appHandlers.test.js` | 未 |
| `diag:rssFailureRate` | `tests/main/ipc/videoHandlers.test.js` | 未 |
| `diag:quotaStatus` | 同上 | 未 |
| `videos:listMissed` | 同上 | 未 |
| `videos:listArchive` | 同上 | 未 |
| `videos:addManual` | 同上 | 未 |
| `videos:listFavorites` | 同上 | 未 |
| `videos:saveFavoriteOrder` | 同上 | 未 |
| `videos:searchByText` | 同上 | 未 |
| `videos:markViewed` | 同上 | 未 |
| `videos:clearViewed` | 同上 | 未 |
| `videos:toggleFavorite` | 同上 | 未 |
| `videos:toggleNotify` | 同上 | 未 |
| `channels:togglePin` | 同上 | 未 |
| `channels:listAll` | 同上 | 未 |
| `channels:addManual` | 同上 | 未 |
| `channels:delete` | 同上 | 未 |
| `channels:syncNow` | 同上 | 未 |
| `settings:get` | `tests/main/ipc/settingsHandlers.test.js` | 未 |
| `settings:set` | 同上 | 未 |
| `settings:export` | 同上 | 未 |
| `settings:import` | 同上 | 未 |
| `favorites:export` | 同上 | 未 |
| `favorites:import` | 同上 | 未 |
| `stats:channelActivity` | `tests/main/ipc/statsHandlers.test.js` | 未 |
| `shell:openFolder` | `tests/main/ipc/appHandlers.test.js` | 既存 |
| `shell:openExternal` | 同上 | 未 |
| `notification:show` | 同上 | 未 |
| `app:version` | 同上 | 未 |
| `updater:quitAndInstall` | 同上 | 未 |
| `updater:checkNow` | 同上 | 未 |
...
| export | テスト | 状態 |
|---|---|---|
| `credentialsExist` | `tests/main/auth.test.js` | 未 |
| `getCredentialsPath` | 同上 | 未 |
| `importCredentialsFromFile` | 同上 | 未 |
| `getAuthenticatedClient` | 同上 | 未 |
| `startAuthFlow` | 同上（4 ケース） | 未 |
| `logout` | 同上 | 未 |
